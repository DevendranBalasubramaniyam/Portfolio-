...
export const HeroSection = () => {
  const handleDownload = () => {
    const pdfPath =
      "https://drive.google.com/file/d/1ukQhkXQtV5T6grhOWSi_OaHzar6m9pyN/view?usp=sharing";
    const link = document.createElement("a");
    link.href = pdfPath;
    link.setAttribute = ("Resume.pdf", pdfPath);
      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          <h1 className="text-white mb-4 text-4xl sm:text-5xl lg:text-8xl lg:leading-normal font-extrabold">
            ...
            <br></br>
            <TypeAnimation
              sequence={["Devendran B", 1000, "Web Developer", 1000]}
              wrapper="span"
              speed={50}
              repeat={Infinity}
            />
